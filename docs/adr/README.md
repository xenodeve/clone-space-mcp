...
| [0006](0006-run-scoped-archive-artifacts-and-capability-flags.md) | Run-scoped archive artifacts, and the §6.4 capability contract | Capture / archive integrity | Pending — contract via #60; implementation #61–#64 |
...
| The remaining **archive contracts** found in the 2026-07-31 review (#21) — ~~capability flags~~ (ADR 0006), request normalization, `TargetRef`, bounded traces, transactional integrity, target inventory, capture budget | capture |
