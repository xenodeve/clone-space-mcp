...
| [0005](0005-checkpoint-coherence-for-archive-artifacts.md) | Checkpoint coherence for archive artifacts | Capture / archive integrity | Pending — contract via #45; implementation not landed |
...
| The remaining **archive contracts** found in the 2026-07-31 review (#21) — capability flags, request normalization, `TargetRef`, bounded traces, transactional integrity, target inventory, capture budget | capture |
